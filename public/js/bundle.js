  ...
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(data, type) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          url = type === 'password' ? 'http://127.0.0.1:8000/api/v1/user/updateMyPassword' : 'http://127.0.0.1:8000/api/v1/user/updateMe';
          _context.next = 4;
          return (0, _axios.default)({
            method: 'PATCH',
            url: url,
...
var stripePromise = (0, _stripeJs.loadStripe)("pk_test_51RNU0tQ7PBKToUeDwKdcWwGLD187t19b6BdOGGFoO5mBl2phYpQuO5om6p2ny6OQbBivtgf5aCeQuPYkAkvi1Xpm00KzbMaG2V");
...
},{"axios":"../../node_modules/axios/index.js","@stripe/stripe-js":"../../node_modules/@stripe/stripe-js/lib/index.mjs","./alerts":"alerts.js"}],"index.js":[function(require,module,exports) {
"use strict";
